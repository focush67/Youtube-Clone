        ...
        <div className="flex flex-col ml-4  md:ml-6 mt-4 md:mt-0 overflow-hidden">
          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold mt-2 flex items-center text-white/[0.5]">
                {video.author.title}
              ...
              <div className="flex text-sm font-semibold text-white/[0.7] mt-1 truncate overflow-hidden">
